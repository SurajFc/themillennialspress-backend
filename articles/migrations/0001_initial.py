    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(default=' ', unique=True)),
                ('category', models.ForeignKey(default=34, on_delete=django.db.models.deletion.CASCADE, related_name='_category', to='articles.Category', verbose_name='category_id')),
            ],
            options={
